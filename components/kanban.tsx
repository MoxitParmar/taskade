...
export const kanbanBoardColumnClassNames =
  'w-86 flex-shrink-0 rounded-lg border flex flex-col border-border bg-sidebar py-2 max-h-full';
...
export function KanbanBoardColumnHeader({
  ...
  return (
    <div
      className={cn('flex items-center justify-between px-4 py-1', className)}
      ref={ref}
      {...props}
    />
  );
